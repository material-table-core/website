...
:::info
**Version 3.0.0 is where we started supporting Material-UI v5. If you are using anything above v3.0.0 you should be good to use Material-UI v5**
:::
...
:::warning
**Most support for v2.x.x has been dropped, we are actively deploying to v3.x.x**
:::
